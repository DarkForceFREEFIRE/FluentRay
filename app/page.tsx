  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#1c1c1c] text-[#f3f3f3]">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto p-4 md:p-6 flex flex-col gap-6">
        ...
        {/* Full-width Header: Establishes a clean visual line above columns */}
        ...
        {/* Aligned Grid: Column elements now share exact top coordinate lines */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
          ...
          <section className="md:col-span-7 flex flex-col gap-4">
            ...
            {!loading && !response && !error && (
              <div className="bg-[#222222] border border-white/5 rounded-lg p-8 text-center flex flex-col items-center justify-center min-h-[360px]">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="bg-[#262626] border border-white/15 rounded-lg p-5 shadow-lg">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    {/* Standardized SVG Dimensions Copy Button (Fixed Scaling Bug) */}
                    <button
                    ...
                    >
                      {copied ? (
                        <>
                          <svg className="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3">
